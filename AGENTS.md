...
Поддомен `апи.хануманфест.рф` **не используем** — API вливается в основной домен.

## Правила работы

1. **Plan → Act → Observe.** Сначала план и согласование, потом код, потом проверка.
...
| Файл | Содержание |
|------|------------|
| `docs/PROJECT.md` | Видение, roadmap, решения |
| `docs/ARCHITECTURE.md` | Схема системы |
