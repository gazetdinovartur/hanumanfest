...
| `https://2026.хануманфест.рф` | Архив 2026 (статика, не WP) | снимок в `legacy/archive-2026/`; выкладка с cutover |
...
| `.cursor/rules` | принимаешь во внимание правила |

## Не делать без запроса

- Коммиты, push, деплой, force/destructive git
- Выкладка архива 2026 и cutover на прод — без запроса
