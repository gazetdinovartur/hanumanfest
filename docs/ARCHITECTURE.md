...
Статический хост на `2026.хануманфест.рф` (не WordPress): HTML-снимок (главная, расписание, питание, политики, оферта), регистрация закрыта, CTA на `https://хануманфест.рф`. Исходник [`legacy/archive-2026/`](../legacy/archive-2026/) — не runtime Symfony. Выкладка вместе с cutover (фаза 6).
...
| `legacy/archive-2026/` | Статический архив сайта 2026 (HTML; медиа не в git) |
